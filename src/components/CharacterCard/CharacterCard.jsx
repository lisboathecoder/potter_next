  ...
  return (
    <li className={styles.card}>
      <div className={styles.cardHeader}>
        ...
        <button
          type="button"
          className={`${styles.favoriteButton} ${isFavorito ? styles.favoriteButtonActive : ""}`}
          onClick={(event) => {
            event.stopPropagation();
            onToggleFavorito(personagem);
          }}
          aria-label={
            isFavorito
              ? `Remover ${personagem.name} dos favoritos`
              : `Adicionar ${personagem.name} aos favoritos`
          }
